...
ColorNames app allows you to present a color name for selected set of colors using external API. There are few bugs in the code. Using tools that Xcode provides to identify bugs such as watching the execution of the code, breakpoints and printing information, fix the the bugs in the app.
